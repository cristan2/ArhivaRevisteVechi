...
$revistaId = filter_input(INPUT_GET, "revista", FILTER_VALIDATE_INT);
$filtruAn = filter_input(INPUT_GET, "an", FILTER_VALIDATE_INT);

if (empty($revistaId)) {
    exit("Nu trebuia să faci asta. Vor fi consecințe...");
}
